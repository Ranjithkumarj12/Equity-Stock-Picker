...
zscore_agg_df['Combined Score'] = (zscore_agg_df['Gross Profit Margin - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Operating Profit Margin - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Pre-tax Margin - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Net Profit Margin - Z-Score (CAGR) - Ranking'] + 
zscore_agg_df['Return on Assets (Added Gr.Interest) - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Operating Return on Assets - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Return on Total Capital - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Return on Equity - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Inventory Turnover - Z-Score (CAGR) - Ranking'] +
zscore_agg_df['Total Asset Turnover - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Fixed Asset Turnover - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Working Capital Turnover - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Current Ratio - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Cash Ratio - Z-Score (CAGR) - Ranking'] +
zscore_agg_df['Financial Leverage - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Interest Coverage (Income) - Z-Score (CAGR) - Ranking'] + zscore_agg_df['CFO-to-Net Revenue - Z-Score (CAGR) - Ranking'] + zscore_agg_df['CFO-to-Assets - Z-Score (CAGR) - Ranking'] + zscore_agg_df['CFO-to-Equity - Z-Score (CAGR) - Ranking'] +
zscore_agg_df['CFO-to-Op.Income - Z-Score (CAGR) - Ranking'] + zscore_agg_df['CFO-to-Debt - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Interest Coverage (CFO) - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Days of Inventory on hand - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Debt-to-Equity - Z-Score (CAGR) - Ranking'] +
zscore_agg_df['Debt-to-Capital Ratio - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Debt-to-Assets - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Earnings to Price - Z-Score (CAGR) - Ranking'] + zscore_agg_df['Sales to Price - Z-Score (CAGR) - Ranking'] + zscore_agg_df['CFO to Price - Z-Score (CAGR) - Ranking'] +
zscore_agg_df['BV to Price - Z-Score (CAGR) - Ranking'] + zscore_agg_df['FCFF to Price - Z-Score (CAGR) - Ranking'])/count_ratios
